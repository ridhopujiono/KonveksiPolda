  ...
  <link href="{{asset('main/assets/vendor/quill/quill.snow.css')}}" rel="stylesheet">
  <link href="{{asset('main/assets/vendor/quill/quill.bubble.css')}}" rel="stylesheet">
  <link href="{{asset('main/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
  <link href="{{asset('main/assets/vendor/simple-datatables/style.css')}}" rel="stylesheet">
